...
public class ProfileEditorDialog extends AlertDialog.Builder
{
    ...
    public ProfileEditorDialog(@NonNull final Activity activity)
    {
        ...
        final ImageView image = view.findViewById(R.id.mshare_layout_profile_picture_image_default);
        final ImageView editImage = view.findViewById(R.id.mshare_layout_profile_picture_image_preferred);
