...
import com.mathrithms.mShare.app.ProgressDialog;
...
public class EstablishConnectionDialog extends ProgressDialog
{
                                     ...
                                     @Nullable final OnDeviceSelectedListener listener)
    {
        ...
        setButton(android.app.ProgressDialog.BUTTON_NEGATIVE, getContext().getString(R.string.butn_cancel), new OnClickListener()
        {
            @Override
