...
import com.mathrithms.mShare.graphics.drawable.TextDrawable;
...
public class NetworkDeviceListAdapter extends EditableListAdapter<NetworkDeviceListAdapter.EditableNetworkDevice, EditableListAdapter.EditableViewHolder>
{
    ...
    public void onBindViewHolder(@NonNull EditableViewHolder holder, int position)
    {
        try {
            ...
            deviceText.setText(hotspotNetwork ? getContext().getString(R.string.text_mShareHotspot) : device.model);
