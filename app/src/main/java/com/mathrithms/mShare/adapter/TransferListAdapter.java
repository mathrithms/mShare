...
import com.mathrithms.mShare.util.TextUtils;
...
import static com.mathrithms.mShare.adapter.TransferListAdapter.*;
...
public class TransferListAdapter
        extends GroupEditableListAdapter<AbstractGenericItem, GroupEditableListAdapter.GroupViewHolder>
        implements GroupEditableListAdapter.GroupLister.CustomGroupLister<AbstractGenericItem>
{
    ...
    public GroupViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        ...
        return new GroupViewHolder(getInflater().inflate(R.layout.list_transfer, parent, false));
    }
