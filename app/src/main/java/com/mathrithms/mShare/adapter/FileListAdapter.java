package com.mathrithms.mShare.adapter;
...
import com.mathrithms.mShare.exception.NotReadyException;
import com.mathrithms.mShare.object.FileShortcutObject;
import com.mathrithms.mShare.object.TransferGroup;
import com.mathrithms.mShare.object.TransferObject;
import com.mathrithms.mShare.object.WritablePathObject;
import com.mathrithms.mShare.util.AppUtils;
import com.mathrithms.mShare.util.FileUtils;
import com.mathrithms.mShare.util.MimeIconUtils;
...
import static com.mathrithms.mShare.adapter.FileListAdapter.*;

public class FileListAdapter
        extends GroupEditableListAdapter<GenericFileHolder, GroupEditableListAdapter.GroupViewHolder>
        implements GroupEditableListAdapter.GroupLister.CustomGroupLister<GenericFileHolder>
{
    ...
    public static class GenericFileHolder extends GroupEditableListAdapter.GroupShareable
    {
        ...
        {
            this(VIEW_TYPE_REPRESENTATIVE, representativeText);
        }
