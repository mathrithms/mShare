...
import static com.mathrithms.mShare.adapter.TransferGroupListAdapter.*;
        ...
        extends GroupEditableListAdapter<PreloadedGroup, GroupEditableListAdapter.GroupViewHolder>
{
    ...
    public GroupViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        ...
        return new GroupViewHolder(getInflater().inflate(R.layout.list_transfer_group, parent, false));
    }
