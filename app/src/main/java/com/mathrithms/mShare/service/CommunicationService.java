package com.mathrithms.mShare.service;
...
import com.mathrithms.mShare.app.Service;
import com.mathrithms.mShare.config.AppConfig;
import com.mathrithms.mShare.config.Keyword;
import com.mathrithms.mShare.database.AccessDatabase;
import com.mathrithms.mShare.exception.AssigneeNotFoundException;
import com.mathrithms.mShare.exception.ConnectionNotFoundException;
import com.mathrithms.mShare.exception.DeviceNotFoundException;
import com.mathrithms.mShare.exception.TransferGroupNotFoundException;
import com.mathrithms.mShare.fragment.FileListFragment;
import com.mathrithms.mShare.object.NetworkDevice;
import com.mathrithms.mShare.object.TextStreamObject;
import com.mathrithms.mShare.object.TransferGroup;
import com.mathrithms.mShare.object.TransferInstance;
import com.mathrithms.mShare.object.TransferObject;
import com.mathrithms.mShare.util.AppUtils;
import com.mathrithms.mShare.util.CommunicationBridge;
import com.mathrithms.mShare.util.CommunicationNotificationHelper;
import com.mathrithms.mShare.util.DynamicNotification;
import com.mathrithms.mShare.util.FileUtils;
import com.mathrithms.mShare.util.HotspotUtils;
import com.mathrithms.mShare.util.NetworkDeviceLoader;
import com.mathrithms.mShare.util.NetworkUtils;
import com.mathrithms.mShare.util.NotificationUtils;
import com.mathrithms.mShare.util.NsdDiscovery;
import com.mathrithms.mShare.util.TimeUtils;
import com.mathrithms.mShare.util.TransferUtils;
...
public class CommunicationService extends Service
{
    ...
    public static final String ACTION_FILE_TRANSFER = "com.mathrithms.mShare.action.FILE_TRANSFER";
    public static final String ACTION_CLIPBOARD = "com.mathrithms.mShare.action.CLIPBOARD";
    public static final String ACTION_CANCEL_INDEXING = "com.mathrithms.mShare.action.CANCEL_INDEXING";
    public static final String ACTION_IP = "com.mathrithms.mShare.action.IP";
    public static final String ACTION_END_SESSION = "com.mathrithms.mShare.action.END_SESSION";
    public static final String ACTION_SEAMLESS_RECEIVE = "com.genonbeta.intent.action.SEAMLESS_START";
    public static final String ACTION_CANCEL_JOB = "com.mathrithms.mShare.transaction.action.CANCEL_JOB";
    public static final String ACTION_TOGGLE_SEAMLESS_MODE = "com.mathrithms.mShare.transaction.action.TOGGLE_SEAMLESS_MODE";
    public static final String ACTION_REVOKE_ACCESS_PIN = "com.mathrithms.mShare.transaction.action.REVOKE_ACCESS_PIN";
    public static final String ACTION_TOGGLE_HOTSPOT = "com.mathrithms.mShare.transaction.action.TOGGLE_HOTSPOT";
    public static final String ACTION_REQUEST_HOTSPOT_STATUS = "com.mathrithms.mShare.transaction.action.REQUEST_HOTSPOT_STATUS";
    public static final String ACTION_HOTSPOT_STATUS = "com.mathrithms.mShare.transaction.action.HOTSPOT_STATUS";
    public static final String ACTION_DEVICE_ACQUAINTANCE = "com.mathrithms.mShare.transaction.action.DEVICE_ACQUAINTANCE";
    public static final String ACTION_SERVICE_STATUS = "com.mathrithms.mShare.transaction.action.SERVICE_STATUS";
    public static final String ACTION_SERVICE_CONNECTION_TRANSFER_QUEUE = "com.mathrithms.mShare.transaction.action.SERVICE_CONNECTION_TRANSFER_QUEUE";
    public static final String ACTION_TASK_STATUS_CHANGE = "com.mathrithms.mShare.transaction.action.TASK_STATUS_CHANGE";
    public static final String ACTION_TASK_RUNNING_LIST_CHANGE = "com.mathrithms.mShare.transaction.action.TASK_RUNNNIG_LIST_CHANGE";
    public static final String ACTION_REQUEST_TASK_STATUS_CHANGE = "com.mathrithms.mShare.transaction.action.REQUEST_TASK_STATUS_CHANGE";
    public static final String ACTION_REQUEST_TASK_RUNNING_LIST_CHANGE = "com.mathrithms.mShare.transaction.action.REQUEST_TASK_RUNNING_LIST_CHANGE";
    public static final String ACTION_INCOMING_TRANSFER_READY = "com.mathrithms.mShare.transaction.action.INCOMING_TRANSFER_READY";
    public static final String ACTION_TRUSTZONE_STATUS = "com.mathrithms.mShare.transaction.action.TRUSTZONE_STATUS";
    public static final String ACTION_REQUEST_TRUSTZONE_STATUS = "com.mathrithms.mShare.transaction.action.REQUEST_TRUSTZONE_STATUS";
    public static final String ACTION_TOGGLE_WEBSHARE = "com.mathrithms.mShare.transaction.action.TOGGLE_WEBSHARE";
    public static final String ACTION_WEBSHARE_STATUS = "com.mathrithms.mShare.transaction.action.WEBSHARE_STATUS";
    public static final String ACTION_REQUEST_WEBSHARE_STATUS = "com.mathrithms.mShare.transaction.action.REQUEST_WEBSHARE_STATUS";
