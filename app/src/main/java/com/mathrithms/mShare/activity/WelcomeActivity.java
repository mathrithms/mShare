...
import com.mathrithms.mShare.widget.DynamicViewPagerAdapter;
...
public class WelcomeActivity extends Activity
{
    ...
    protected void setUserProfile()
    {
        if (mProfileView != null) {
            ...
            ImageView imageView = mProfileView.findViewById(R.id.mshare_layout_profile_picture_image_default);
            ImageView editImageView = mProfileView.findViewById(R.id.mshare_layout_profile_picture_image_preferred);
